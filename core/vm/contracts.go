...
var PrecompiledContractsEspresso = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{19}): &bls12377G1Add{},
	common.BytesToAddress([]byte{20}): &bls12377G1Mul{},
	common.BytesToAddress([]byte{21}): &bls12377G1MultiExp{},
	common.BytesToAddress([]byte{22}): &bls12377G2Add{},
	common.BytesToAddress([]byte{23}): &bls12377G2Mul{},
	common.BytesToAddress([]byte{24}): &bls12377G2MultiExp{},
